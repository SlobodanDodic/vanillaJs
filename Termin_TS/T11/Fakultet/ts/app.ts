...
function wireEvents(): void {
  ...
  document.getElementById("dodajIspit").addEventListener("click", () => {
    ...
    let index: string = (document.getElementById("indeks") as HTMLInputElement).value;
    ...
    let teorija: number = Number((document.getElementById("teorija") as HTMLInputElement).value);
    let kolokvijum: number = Number((document.getElementById("kolokvijum") as HTMLInputElement).value);

    let ispitTeorija: Ispit = new Ispit(aktivanPredmet, index, ime, prezime, "teorija", datum, teorija);
    let ispitPraksa: Ispit = new Ispit(aktivanPredmet, index, ime, prezime, "kolokvijum", datum, kolokvijum);
  ...
  document.getElementById("izracunajProlaznostPoPredmetu").addEventListener("click", () => {
    let nacin: string = (document.getElementById("nacinPolaganjaSelekt") as HTMLInputElement).value;
