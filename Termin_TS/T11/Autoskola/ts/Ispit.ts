...
class Ispit {
	...
	constructor(instruktor: Instruktor, imeKandidata: string, prezimeKandidata: string, jmbgKandidata: number, nacinPolaganja: string, datum: string, brojBodova: number) {
