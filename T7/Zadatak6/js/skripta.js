...
var Student = /** @class */ (function () {
    ...
    Student.prototype.omiljeniProfesori = function () {
        ...
        for (var _i = 0, _a = this._polozeni_predmeti; _i < _a.length; _i++) {
            var predmet = _a[_i];
            if (predmet.ocena === 11) {
                omiljeniProfesori.push.apply(omiljeniProfesori, predmet.imena_profesora);
            }
        }
...
var Predmet = /** @class */ (function () {
    function Predmet(_id, _naziv_predmeta, _imena_profesora, _ocena) {
        this._id = _id;
        this._naziv_predmeta = _naziv_predmeta;
        this._imena_profesora = _imena_profesora;
        this._ocena = _ocena;
    }
    ;
    ...
    Object.defineProperty(Predmet.prototype, "imena_profesora", {
        get: function () {
            return this._imena_profesora;
        },
        enumerable: false,
        configurable: true
    });
